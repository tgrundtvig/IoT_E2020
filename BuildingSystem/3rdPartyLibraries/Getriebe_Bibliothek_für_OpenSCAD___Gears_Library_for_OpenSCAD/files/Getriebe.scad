...
//zahnstange(modul=2, laenge=100, hoehe=8, breite=2, eingriffswinkel=20, schraegungswinkel=0);
d = 20;
teeth = 16;
fitting = 0.2;
bore = 3.4;
...
spiel = 0.05+2*fitting/(mod*PI);
echo("spiel: ",spiel);

spiel = 0.05;
s = 1 - 2*fitting/d; 
//scale([s,s,1])
//stirnrad(modul=d/teeth, zahnzahl=teeth, breite=width, bohrung=bore/s, eingriffswinkel = 20, schraegungswinkel = 0, optimiert = true);
//pfeilrad(modul=d/teeth, zahnzahl=teeth, breite=width, bohrung=bore/s, eingriffswinkel = 20, schraegungswinkel=20, optimiert=true);

//hohlrad(modul=d/teeth, zahnzahl=teeth, breite=width, randbreite=1, eingriffswinkel = 20, schraegungswinkel = 0);
//kegelrad(modul=d/teeth, zahnzahl=teeth, teilkegelwinkel=45, zahnbreite=2, bohrung=bore/s, eingriffswinkel = 20, schraegungswinkel=0);

//pfeilkegelrad(modul=d/teeth, zahnzahl=teeth, teilkegelwinkel=45, zahnbreite=4, bohrung=bore/s, eingriffswinkel = 20, schraegungswinkel=20);

/*
spiel = 0;
zahnstange(modul=d/teeth, laenge=PI*20, hoehe=5, breite=4, eingriffswinkel = 20, schraegungswinkel = 0);
*/
...
// planetengetriebe(modul=1, zahnzahl_sonne=16, zahnzahl_planet=9, anzahl_planeten=5, breite=5, randbreite=3, bohrung=4, eingriffswinkel=20, schraegungswinkel=30, zusammen_gebaut=false, optimiert=true);
...
// kegelradpaar(modul=20/8, zahnzahl_rad=16, zahnzahl_ritzel=16, achsenwinkel=90, zahnbreite=5, bohrung=4, eingriffswinkel = 20, schraegungswinkel=20, zusammen_gebaut=true);
...
// pfeilkegelradpaar(modul=1, zahnzahl_rad=30, zahnzahl_ritzel=11, achsenwinkel=100, zahnbreite=5, bohrung_rad=3, bohrung_ritzel=3, eingriffswinkel = 20, schraegungswinkel=30, zusammen_gebaut=true);

// schnecke(modul=20/16, gangzahl=4, laenge=20, bohrung=5.2, eingriffswinkel=20, steigungswinkel=10, zusammen_gebaut=true);
// translate([20,20,0])
// stirnrad (modul=20/16, zahnzahl=16, breite=5, bohrung=3, eingriffswinkel=20, schraegungswinkel=-10, optimiert=true);

 //schneckenradsatz(modul=20/16, zahnzahl=16, gangzahl=2, breite=5, laenge=20, bohrung_schnecke=5.4, bohrung_rad=4, eingriffswinkel=20, steigungswinkel=10, optimiert=true, zusammen_gebaut=true);